...
import { Plus, Trash2, Settings, Calendar, Layers, TrendingUp } from 'lucide-react';
...
export function SimulationStep() {
  ...
  const { simulation_params } = state.proposal;
    ...
    <div className="space-y-6 animate-fade-in">
      <div>
        ...
        <p className="text-muted-foreground mt-1">
          Configure os prazos, faixas de entrada e fases da obra
        </p>
      </div>
