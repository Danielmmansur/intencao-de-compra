...
export function PropertyStep() {
  ...
  return <div className="space-y-6 animate-fade-in">
      ...
      {/* Summary */}
      {property.sale_value > 0 && <Card className="bg-primary/5 border-primary/20">
          <CardContent className="flex items-center justify-between py-4">
            ...
            {property.appraisal_value && property.appraisal_value !== property.sale_value && <div className="text-right">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card className="lg:col-span-2">
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              ...
              <Input id="empreendimento" value={property.empreendimento_name || ''} onChange={e => updateField('empreendimento_name', e.target.value)} placeholder="Ex: Residencial Parque das Flores" />
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Input id="block" value={property.block || ''} onChange={e => updateField('block', e.target.value)} placeholder="Ex: Bloco A" />
              </div>
              <div className="space-y-2">
                <Label htmlFor="unit">Unidade / Apartamento *</Label>
                <Input id="unit" value={property.unit || ''} onChange={e => updateField('unit', e.target.value)} placeholder="Ex: 101" />
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <CurrencyInput value={property.appraisal_value || 0} onChange={val => updateField('appraisal_value', val)} />
            <p className="text-xs text-muted-foreground mt-2">
